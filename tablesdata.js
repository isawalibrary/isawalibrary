...
children:[
	...
	{"Skill Group":"Artisan Skill Group<p>To craft a piece of art ",
	Skill:"Artisan skills:<br><span class='l5r'>b</span> Aesthetics: Nonutilitarian art <br><span class='l5r'>b</span> Composition: Literature and poetry <br><span class='l5r'>b</span> Design: Finery and worn art <br><span class='l5r'>b</span> Smithing: Armor and weapons ",
	Approach:"Artisan approaches: <p><span class='l5r earth'>e</span> Restore a damaged piece through upkeep <br><span class='l5r water'>w</span> Adapt an existing piece into something else <br><span class='l5r fire'>f</span> Invent a new piece from raw materials <br><span class='l5r air'>a</span> Refine an existing piece to make it function better <br><span class='l5r void'>v</span> Attune yourself to a piece of art "},
	{"Skill Group":"Social Skill Group<p>To influence a person",
	Skill:"Social skills:<br><span class='l5r'>b</span> Command: How to assert authority over others, especially of lower status <br><span class='l5r'>b</span> Courtesy: How to appeal formally to others, especially of higher status <br><span class='l5r'>b</span> Games: How to discuss and play games to socialize <br><span class='l5r'>b</span> Performance: How to communicate with and influence an audience ",
	Approach:"Social approaches <p><span class='l5r earth'>e</span> Reason with them to act based on logic and duty <br><span class='l5r water'>w</span> Charm them to develop positive feelings toward you <br><span class='l5r fire'>f</span> Incite them to act on their emotions and desires <br><span class='l5r air'>a</span> Trick them into believing something you want them to believe <br><span class='l5r void'>v</span> Enlighten them to understand a fundamental truth "},
	{"Skill Group":"Scholar Skill Group<p>To know or learn a piece of information ",
	Skill:"Scholar skills:<br><span class='l5r'>b</span> Culture: Current events, historical trends, and etiquette <br><span class='l5r'>b</span> Government: Law, bureaucracy, posts, and positions <br><span class='l5r'>b</span> Medicine: Health, injury, and disease <br><span class='l5r'>b</span> Sentiment: Psychology, emotions, and motivations <br><span class='l5r'>b</span> Theology: The spiritual realms, mystical beings and phenomena, and religious rites ",
	Approach:"Scholar approaches <p><span class='l5r earth'>e</span> Recall it from memory <br><span class='l5r water'>w</span> Survey the surroundings for clues about it <br><span class='l5r fire'>f</span> Theorize possibilities of its nature <br><span class='l5r air'>a</span> Analyze a specific thing for details about it <br><span class='l5r void'>v</span> Sense it with your instincts or a hunch "},
	{"Skill Group":"Martial Skill Group<p>To overcome an opponent or challenge with force ",
	Skill:"Martial skills:<br><span class='l5r'>b</span> Fitness: Performing athletic feats and resisting harm <br><span class='l5r'>b</span> Martial Arts [Melee]: Using close-quarters arms <br><span class='l5r'>b</span> Martial Arts [Ranged]: Using missile weapons <br><span class='l5r'>b</span> Martial Arts [Unarmed]: Fighting bare-handed and with improvised weapons <br><span class='l5r'>b</span> Meditation: Mastering oneself and controlling emotion such as anger, fear, and hate <br><span class='l5r'>b</span> Tactics: Fighting with squads and armies ",
	Approach:"Martial approaches: <p><span class='l5r earth'>e</span> Withstand opposing force to wear it down <br><span class='l5r water'>w</span> Shift opposing force to work against itself or for you <br><span class='l5r fire'>f</span> Overwhelm opposing force with a quick burst of power <br><span class='l5r air'>a</span> Feint to lure opposing force into a position of vulnerability <br><span class='l5r void'>v</span> Sacrifice to let opposing force score a victory so that you can achieve a greater end "},
	{"Skill Group":"Trade Skill Group<p>To get resources or perform work ",
	Skill:"Trade skills:<br><span class='l5r'>b</span> Animal Handling: Direct, communicate with and work with animals  <br><span class='l5r'>b</span> (Commerce: Sales, trading, and speculation <br><span class='l5r'>b</span> Labor: Farming, construction, and production <br><span class='l5r'>b</span> Seafaring: Sailing and living on the ocean <br><span class='l5r'>b</span> Skulduggery: Criminal organizations and activities <br><span class='l5r'>b</span> Survival: Living in the wilds beyond civilization ",
	Approach:"Trade approaches: <p><span class='l5r earth'>e</span> Produce what you need through physical toil <br><span class='l5r water'>w</span> Exchange one type of labor or resources for another <br><span class='l5r fire'>f</span> Innovate a new way to get what you need <br><span class='l5r air'>a</span> Con someone to get something for nothing <br><span class='l5r void'>v</span> Subsist in your environment without disrupting it "}
	]},
	{
...
ref:"HonorRanks",
children:[
	{status: "HONOR", example:"DESCRIPTION: (Core p302)"},
	{status: "100", example:"Honor Is Stronger than Steel: The character believes that Bushido is worth upholding at any cost, and do so even unto death. "},
	{status: "80 - 99", example:"Never Stray from the Way: The character has given up much to embody the ideals of Bushido, and they shall continue to do so as honor requires. They would rather forfeit their personal desires than fail to live up to their own expectations"},
	{status: "65 - 79", example:"My Honor Is My Life: Those who live in accordance with Bushido are strengthened by it, and can endure the hardships it requires of them. Rarely, they may slip, but afterward they cannot easily forgive themself."},
	{status: "30 -64", example:"Honor Is the Ideal: Most samurai are brought up to believe in Bushido and strive to embody its virtues. When the character speaks and acts, it is with honor in mind, but they are still human and periodically succumb to temptation, or they are simply willing to sacrifice their honor if they must. Importantly, they still feel guilt over betraying their ideals."},
	{status: "20 - 29", example:"Honor Is about Appearances: While the character does not reliably uphold the virtues of Bushido, they still recognize the importance of honor to society and play the part of a samurai.  "},
	{status: "1 - 19", example:"Honor Is a Nicety: They believe that most of the tenets get in the way of what they need - or want - to accomplish. Their reality no longer aligns with samurai ideals, so they have given up on such luxuries."},
	{status: "0", example:"I Make My Own Code: The character has completely lost faith in Bushido and adheres to another code - or none at all!"},
	]},
	{
title:"Status",
ref:"StatusRanks",
children:[
	{status: "STATUS", example:"EXAMPLES: (Core p305)"},
	{status: "100", example:"The ruling Emperor"},
	{status: "90 - 99", example:"The Imperial Spouse, the Voice of the Emperor, the Emperor's children, daimyo of the Imperial families, the Emerald Champion, the Jade Champion, the Imperial Advisor, the Imperial Chancellor"},
	{status: "80 - 89", example:"Great Clan Champion."},
	{status: "70 - 79", example:"Minor Clan Champion, the Imperial Herald, the Imperial Treasurer, a Great Clan family daimyo, a great general."},
	{status: "60 -69", example:"A hatamoto, a provincial governor, a commander of multiple companies."},
	{status: "50 - 59", example:"A city governor, a captain of a military company, a vassal family daimyo."},
	{status: "40 - 49", example:"Karo, Emerald/Jade Magistrate, revered sensei, clan magistrate, lieutenant"},
	{status: "30 - 39", example:"Abbot of the Brotherhood, average Great Clan samurai"},
	{status: "25 - 29", example:"Average Minor Clan or vassal family samurai, monk of the Brotherhood"},
	{status: "20 - 24", example:"Village officer, disgraced samurai, ronin"},
	{status: "10 - 19", example:"Ashigaru, artisan, laborer"},
	{status: "1 - 9", example:"Merchant, bandit"},
	{status: "0", example:"Burakumin (entertainer, geisha, leatherworker, butcher, torturer, or gravedigger), one outside the Celestial Order"},
	]},
	{
title:"Glory",
ref:"GloryRanks",
children:[
	{status: "GLORY", example:"DESCRIPTION: (Core p304)"},
	{status: "100", example:"Undying Legend: A legendary hero, whose deeds are worthy of poetry and song, and is known even among peasants and foreigners"},
	{status: "90 - 99", example:"Renowned Hero: A samurai counted among the greatest in their clan, whose exploits have spread to the far corners of the Empire"},
	{status: "80 - 89", example:"Exceptional Samurai: One whose impressive deeds have garnered attention in the courts of other clans"},
	{status: "65 - 79", example:"Respected Adept: A samurai of great accomplishment, whose name is known outside their family."},
	{status: "60 -64", example:"Worthy Retainer: An extremely competent and valued samurai"},
	{status: "45 - 59", example:"Reputable Samurai: A samurai known for their effectiveness and reliability"},
	{status: "40 - 44", example:"Unremarkable Retainer: An ordinary samurai"},
	{status: "30 - 39", example:"Samurai of No Renown: A samurai whose reputation is marred by failure, disappointment, or ill omen"},
	{status: "20 - 29", example:"Disappointment: Someone considered incompetent or untrustworthy"},
	{status: "10 - 19", example:"Renegade: An individual who has become known for their misdeeds across several provinces"},
	{status: "1 - 9", example:"Villain: An individual whose heinous acts are known across the land"},
	{status: "0", example:"Figure of Dread: One of the most vile or scandalous individuals in the Empire"},
	]},
	{
title:"Weapons",
ref:"Weapons",
children:[
	...
	{name: "Moshi Sun Axe", skill:"[Melee]", category:"Polearm / Axe", range:"1-2", damage:"3", deadliness:"5", grips:"(1-hand: - / 2-hand: Damage +3)", qualities:"Ceremonial, Cumbersome, Resplendent", rarity:"8", price:"20 koku", source:"Celestial Realms p98"},
{name: "Shakujo", skill:"[Melee]", category:"Polearm", range:"1", damage:"4", deadliness:"1", grips:"(1-hand: - / 2-hand: Damage +1)", qualities:"Ceremonial", rarity:"4", price:"5 bu", source:"Celestial Realms p98"},
{name: "Tachi", skill:"[Melee]", category:"Sword", range:"1", damage:"5", deadliness:"5", grips:"(1-hand: - / 2-hand: Deadliness +1):", qualities:"Ceremonial, Cumbersome, Razor-Edged", rarity:"8", price:"25 koku", source:"Celestial Realms p98"},
{name: "Uchigatana", skill:"[Melee]", category:"Sword", range:"1", damage:"3", deadliness:"6", grips:"(1-hand: -)", qualities:"Razor-Edged, Wargear", rarity:"8", price:"16 koku", source:"Celestial Realms p98"},
{name: "Whip", skill:"[Melee]", category:"Specialist", range:"2", damage:"3", deadliness:"2", grips:"(1-hand: -)", qualities:"Ensnaring, Mundane", rarity:"2", price:"4", source:"Celestial Realms p98"},
	]},
	{
title:"Armors",
ref:"Armors",
