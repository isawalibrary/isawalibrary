...
var archetypes =[
		{
			...
			armor:["Demonic Hide"],
			qualities:"Of all the horrors to stalk forth from the Shadowlands, the demonic creatures called oni are by far the most powerful and dangerous. With twisted horns, razor-sharp teeth, and enormous talons on their hands and feet, these bestial creatures resemble the very Hells in which they dwell. Fortunately, they are only able to enter Ningen-dō of their own volition through the Festering Pit. Unfortunately, there is another way for oni to come to Ningen-dō that is far more insidious: invitation by misguided or evil mortals. Only when they are slain do their souls return to Meido, although the powerful ones are able to make their way back to Jigoku itself to be reborn. An oni is an Otherworldly, Tainted being of silhouette 4.",
			abilities:[
			...
			qualities:"Rokugani funerary rites involve cremation, and for good reason. Despite the costs it entails, this is afforded even to the lowliest members of society—for in Rokugan, the dead do not sleep soundly, and ancient stories tell of the days when cults of mahō-tsukai wandered the land backed by vast armies of the hungering dead. An zombie peasant is an Otherworldly, Tainted being of silhouette 2.",
			abilities:[
		...
		},
		{
			...
			qualities:"Illustrative of the Taint’s ability to corrupt nearly anything, a kyōrinrin is a being composed of scrolls, origami, or essentially anything else made of paper. Given their nature, they may not appear particularly dangerous. This is deceptive, however, as the power motivating kyōrinrin is a strong one, and they can bind, blind, or even smother their foes. The paper that composes them can be torn or burned, but they are tenacious and continue to attack, usually until they are completely destroyed.  A kyorinrin is an Otherworldly, Tainted being of silhouette 3.  ",
			...
			qualities:"A revenant is a powerful undead servant, a creature that retains some intelligence and knowledge from its former life. If the mahō-tsukai who creates it wishes, they can supply a revenant with an onikage mount (see page 23) and even a group of animated dead that are ordered to obey the revenant’s command. Such revenants can act as champions for the mahō-tsukai, but the practitioner should be certain of the revenant’s loyalty before bestowing such power. A revenant is an Otherworldly, Tainted being.",
			...
			qualities:"A wanyūdō has the bizarre form of the flaming wheel of an oxcart, with a screaming human head for its hub. It rolls with preternatural speed across virtually any terrain, including water, attempting to wrench the soul from any mortal being it encounters. Each is said to be the tortured ghost of someone who was an oppressive tyrant while alive. It is a terrifying foe, especially when encountered outside of the Shadowlands.  A wanyudo is an Otherworldly, Tainted being of silhouette 2.  ",
			...
			},
		{
			...
			armor:["Soft Fur"],
			qualities:"There are several varieties of fox that are native to Rokugan, including the dusty white snow fox, the more common red, black, and white fox, and the rare silver fox. These creatures are considered intelligent and for many conjure up images of the trickster􀂇spirits known as kitsune.  A fox is a creature of silhouette 0",
