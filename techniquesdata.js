...
reference: "Core 215",
ring: "Air",
effect: "Activation: As a Scheme action, you may make a TN 1 Courtesy (Air) check targeting a Compromised character. <p>Effects: If you succeed, your target must choose one of the following: <br>Immediately unmask in a manner of their choosing based on the circumstances. <br>Forfeit glory equal to your Air Ring plus your bonus <span class='l5r'>S</span> to leave the scene. <p>New Opportunities <br>Air:<span class='l5r'>O</span>+: If the target chooses to unmask, you learn one of their disadvantages of their choice per <span class='l5r'>O</span> spent this way. <br>Air <span class='l5r'>O</span> <span class='l5r'>O</span>: If the target chooses to leave the scene, you notice their destination from the direction of their departure or overhear from the crowd where they will retreat."},{
...
reference: "Core 211",
ring: "Water",
effect: "Activation: As a Support action, you may make a TN 2 Theology (Water) check to spread one chosen persistent invocation effect across a number of targets equal to your Water Ring at range 0-1 .<p>Effects: If you succeed, you augment the spiritual power of one persistent invocation effect that is al ready affecting one target. Each other target counts as being affected by it as well. This effect persists as long as the original effect persists on the original target. <p>New Opportunities<br>Water <span class='l5r'>O</span> <span class='l5r'>O</span>: You may choose a condition that the target is suffering instead of a persistent invocation effect ."},{
...
reference:"Core p183",
ring:"Air",
effect:"Activation: As an Attack and Support action, you may make a TN 1 Martial Arts [Unarmed] (Air) check to empower your unarmed blows. When you perform this action , you may choose one other character at range 0-1 as the target for the burst effect. <p>Enhancement Effect: If you succeed, this kiho activates. While this kiho is active, treat the maximum range of your punch and kick unarmed weapon profiles (Core p237) as equal to your Air Ring .<br>Burst Effect: If you have two or more bonus <span class='l5r'>S</span>, you deal physical damage to the target equal to your Air Ring. Your target must make a TN 4 Fitness check (Earth 5, Fire 2) or be pushed 1 range band away from you, plus a number of range bands equal to their shortfall."},{
title:"Earthen Fist",
type:"Kiho",
rank:1,
reference:"Core p183",
...
reference: "Path of Waves",
ring: "Void",
effect: "Activation: Once per scene as a Support action, if you are in a Void stance, you may focus on protection what is important to you.  <p>Effects: You remove 3 fatigue and 3 strife, plus 3 fatigue and 3 strife for each Compromised or Incapacitated character in the scene with whom you share a Bond.",},
{
