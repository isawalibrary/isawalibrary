...
var protheme = ["Aka","Aki","Ari","Atsu","Chika","Fusa","Haru","Hide","Hira","Hiro","Hisa","Ie","Kado","Kage","Kane","Katsu","Kore","Kimi","Kiyo","Kuni","Masa","Masa","Michi","Mitsu","Mochi","Mori","Moto","Mune","Naga","Naka","Nao","Nari","Nobu","Nori","Rei","Sada","Sane","Shige","Sue","Sumi","Tada","Tae","Taka","Tame","Tane","Teru","Toki","Tomo","Toshi","Tsune","Tsura","Uji","Yasu","Yori","Yoshi","Yuki","Yuzu"]

var mdeuterotheme = ["aki","akira","chika","fusa","haru","hide","hiko","hira","hiro","hisa","hito","ie","ichi","kado","kage","kane","kata","katsu","kaze","kiyo","kuni","maro","masa","michi","mitsu","mochi","mori","moto","mune","mura","naga","naka","nao","nari","nobu","nori","o","ru","sada","sane","shige","suke","tada","taka","tane","teru","toki","tomi","tomo","toshi","tsugu","tsura","tsune","uji","yasu","yori","yoshi","yuki","zane","zo"]

var fdeuterotheme = ["ko","yo","ka","na","e","ne","mi"]

var	names = ["Aika","Aka","Aki","Akihiko","Akiko","Akinari","Akira","Amaya","Aoi","Atsushi","Ayaka","Ayame","Ayane","Azuma","Chieko","Chiharu","Daikichi","Daisetsu","Daisuke","Daiyu","Eiji","Eisuke","Emi","Emiko","Fukuro","Fumi","Genbu","Genichi","Hachi","Haitaka","Hajime","Hamatsu","Haruhi","Haruka","Haruo","Hatoka","Hayato","Hibi","Hideaki","Hikaru","Hiroaki","Hizaya","Hozumi","Ichijo","Ikaru","Inoue","Isamu","Isuka","Izumi","Iwakura","Jiro","Jun","Kaede","Kaharu","Kamome","Kaori","Kasumi","Katsuo","Kazue","Kazuhiko","Kei","Keita","Kenji","Kenmi","Kiji","Kiko","Kiro","Kiyoko","Kohaku","Koji","Kokoro","Koma","Kuina","Kujaku","Kumo","Kurina","Kurumi","Kyo","Madoka","Mai","Mana","Mariko","Maru","Masahiko","Mashiro","Mayu","Mayumi","Michi","Midori","Mika","Minoru","Mirai","Misago","Mitsuru","Miyu","Mori","Mozu","Nao","Naoha","Naoki","Naota","Naoto","Natsuki","Orihime","Osamu","Rei","Reizo","Renjaku","Rika","Rin","Ruka","Ryota","Sagi","Saito","Sakura","Sannosuke","Sanzeni","Satoru","Sayuri","Sazai","Seiji","Sen","Shiho","Shinichi","Shizuru","Shotaro","Shoubin","Shunsuke","Sora","Sui","Sumika","Sumiyo","Suzaku","Suzu","Suzune","Tadashi","Tae","Taka","Takako","Takara","Takumi","Takuya","Tana","Terukazu","Toki","Tomoe","Torayuki","Toyoshige","Tsorika","Tsubaki","Tsubame","Tsuki","Tsukika","Tsutsuki","Usa","Uzura","Washi","Wataru","Yanagi","Yasu","Yoriko","Yoshiaki","Yuka","Yukari","Yuki","Yukino","Yuuki","Yuzuhime","Zennosuke","Zetsuha","Zuku"];
