...
Unicorn:{
	...
	Imperial:{
		cartographer: {
			...
			startingtechs: ['Striking as Earth',"Artisan's Appraisal"],
			startingtechoptions: ["Warrior's Resolve",'Civility Foremost'],
	...
	Other:{
		...
		mercenaryninja: {
			...
			rank4techs:["Hidden in Smoke","Breath of the Wind Style"],
