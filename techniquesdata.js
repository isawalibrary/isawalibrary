...
effect: "Activation: As a Support action, you may make a TN 2 Theology (Air) check targeting one cha racter you know by name. Effects: If you succeed, you summon a sma ll animal from Chikusho-do of silhouette 0 to deliver a short message to the target you chose. The message can be understood by the recipient, but it must contain twenty words or fewer. The animal arrives at your target's location, regardless of distance, within eight hours, or sooner at the GM's discretion. <p>New Opportunities <br>Air <span class='l5r'>O</span>+ : The messenger arrives one hour sooner per each ~~ spent this way. The messenger takes a minimum of one hour to get to its target (unless the GM decides it arrives sooner). <br>Air <span class='l5r'>O</span> + : The message can be ten words longer per ~' spent this way. <br>Air <span class='l5r'>O</span><span class='l5r'>O</span> The recipient may respond to your message (so long as they are able) with up to the same number of words you sent. The message is delivered to you within the same amount of time it took to send it to your target."
},{
...
reference: "Celestial Realms p106",
ring: "Air",
fluff: "'The haze ofYume-do can cloud even the waking mind with promises of another path, another life, another outcome. There are those so lost in the allure of possibility that they fail to realize that opportunity is often sitting just beside them.' - Noboru, Mystic of the Mountain",
effect: "Activation: Once per scene as a Scheme action, you may make a TN 2 Theology (Air) check targeting yourself. Effects: If you succeed, you augment yourself with a cloak of dreams. NPCs with a vigi lance lower than 1 plus your bonus successes forget any interactions they had (or have) with you during this scene at the conclusion of the scene. If you attempt violence during the scene, this effect immediately ends. <p>New Opportunities <br>Air <span class='l5r'>O</span><span class='l5r'>O</span>+: You may target one ally other than yourself to additionally benefit from the effects of this spell per each <span class='l5r'>O</span><span class='l5r'>O</span> spent this way."
},{
...
effect: "Activation: As a Support action, you may make a TN 1 Theology (Fire) check targeting one character or item of silhouette 2 or lower at range 0-3. <p>Effects: If you succeed, you summon a pleasant ray of sunlight that follows the target. The ray of sunlight provides light at range 0-2 of the target's position. This effect persists for one round, plus additional rounds equal to your bonus successes. <p>New Opportunities <br>Fire <span class='l5r'>O</span>+: The light provided extends out 1 additional range band from the target's position per :;> spent this way. <br>Fire <span class='l5r'>O</span>+: The silhouette of the target affected by this invocation can be 1 higher per:;> spent this way. <br>Fire <span class='l5r'>O</span><span class='l5r'>O</span>: The ray provides enough heat to warm several beings and creatures on a cold night. <br>Fire <span class='l5r'>O</span><span class='l5r'>O</span>: The light negates the effects of Obscuring terrain within the range it illuminates."
},{
...
effect: "Activation: As a Support action, you may make a TN 2 Theology (Water) check targeting yourself. <p>Effects: If you succeed, you augment yourself. You gain one of the following effects of your choice, and it persists for a number of rounds equal to one plus your bonus successes: <br><span class='l5r'>p</span> Eyes of the Falcon: Your eyes transform into those of a falcon . You may reroll up to three dice when making checks to spot details or see things at a distance. <br><span class='l5r'>p</span> Nose of the Fox: Your nose and mouth elongate into the snout of a fox. You may reroll up to three dice when making checks related to your sense of smell, such as tracking someone down or identifying a substance. <br><span class='l5r'>p</span> Ears of the Bat: Your ears morph into those of a bat. You may reroll up to three dice when making checks for which your exceptional hearing would be a benefit, such as listening in on a conversation or listening to an animal's footfalls before springing a trap. <br><span class='l5r'>p</span> Might of the Bear: Your body and muscles enlarge to the size of those of a bear. Your silhouette increases to 3, and you may reroll up to three dice when making checks that can take advantage of your size, such as lifting heavy objects or attempting to look intimidating. <br><span class='l5r'>p</span> Elegance of the Moth: Your skin becomes spotted with patches of the feathery, soft fibers of a moth. Your silhouette decreases to 1, and you may reroll up to three dice when making checks that can take advantage of your lithe figure, such as maneuvering into tight spaces or attempting to evade a critical blow."
},{
...
effect: "Activation: As a downtime activity, you may make a TN 2 Performance (Water) check targeting everyone in the scene. <p>Effects: If you succeed, each target removes 3 strife and 3 fatigue. <p>New Opportunities <br>Wate r <span class='l5r'>O</span><span class='l5r'>O</span>: Select a number of participants up to your Water Ring. Each of those characters decreases the TN of their next Social skill check by 2 (to a minimum of 1 )."
},{
...
effect: "Activation: As a Support action, you may make a TN 2 Sentiment (Void) check targeting yourself and one other character at range 0-3. <p>Effects: If you succeed, you augment all targets with the abi lity to communicate with each other without words, making their intentions clear even if they do not speak the same language. When any target makes a check, one other target may receive 2 fatigue to provide assistance on the check regardless of distance. This effect lasts until the end of the scene. <p>New Opportunities <br><span class='l5r'>O</span>+:Choose one additional target per <span class='l5r'>O</span>, spent this way. <p>Magnitude <br>Magnitude 1 +:<span class='l5r'>O</span>When a target is dealt strife, one other target of your choice may receive that strife instead. <br>Magnitude 3+: Choose a ring or skill. When any target makes a check using that ring or skill, they may use any other target's rank in that ring or skill instead of their own."
},{
...
reference: "Celestial Realms p115",
ring: "Void",
fluff: "The Void is nonexistence; therefore, within it, all possibilities exist. One who attunes their senses to nonexistence can perceive the other possible realities that ripple outward from each moment of action. The signs often do not come as complete visions, but as brief flashes: hazy vignettes of a world that never was. The rustling of /eaves from a tree that has not yet grown, the first laugh shared with a new friend, the scent of blood and burning flesh. However, these rippling potential truths can become intoxicating, drawing an undisciplined mind deeper and deeper into twisted realms of refracted possibility until there is no escape. This is what those who study the Void call the 'Lying Darkness ': the trap that awaits all who let their worldly desires guide their ventures into the Void.",
effect: "Activation: Once per session, immediately after you or another character at range 0-3 performs an action or makes a choice of great consequence in a narrative scene, you may make a TN 2 Theology (Void) check targeting that character to peer beyond the lie of t ime and find another outcome. <p>Effects: If you succeed, you scry for another outcome and return to the moment before the action was performed. All effects and outcomes stemming from the action are undone, but only you and the target are aware of the reality that no longer is. If you are the target, you may choose the same or a different action or decision. If another character is the target, you may say up to five words to the target before they act or make a decision. <p>New Opportunities <br><span class='l5r'>O</span>: If you target another character and you succeed, you may perform an action immediately before the target performs their new action. <p>Magnitude <br>Magnitude 1 + : You see one possible consequence of the origina l action or decision that would occur before the end of the scene. <br>Magnitude 2+: You see one additiona l possible consequence of the original action or decision that would occur in the next year. <br>Magnitude 3+: You see one additiona l possible consequence of the original action or decision that would occur in the next decades, or even further in the future."
},{
...
effect: "Activation: As a Scheme and Support action, you may make a Theology (Void) check targeting one character or one mundane, physical object at range 0-1. The TN of t his check is equal to the character's vigi lance, or 2 if you are targeting an object. <p>Effects: If you succeed and your target is an object, you scry for the ways the target can be undone. The TN of your next check to damage, sabotage, or otherwise disable it is 1 (and cannot be increased). This effect persists until the end of your next turn. If you succeed and you r target is a character, you scry for the moves that wi ll lead to their downfall. The TN of your next Attack or Scheme action targeting that character is 1 (and cannot be increased). This effect persists until the end of you r next turn . <p>New Opportunities <br>:<span class='l5r'>O</span>+:Choose one additional target per <span class='l5r'>O</span> spent this way. <p>Magnitude <br>Magnitude 1-3: This effect persists for a number of additional rounds equal to the magnitude. <br>Magnitude 2+: In addition to physical objects, you can choose metaphysica l objects, such as the ongoing effects of invocations, maho, kiho, or rituals (or other persistent mystical phenomena, at the GM's discretion). <br>Magnitude 4+: This effect persists unti l the end of the scene instead."
},{
...
effect: "Activation: Once per scene as a Scheme action, you may make a Theology (Void) check targeting one character or object at range 0-3. The TN is equal to your target's vigilance plus its silhouette (or only its si lhouette if it is an object). <p>Effects: If you succeed, you bind your target to a space outside of reality. As your target is no longer present in reality, it is unaffected by anything that would otherwise affect it and does not affect anything. This effect persists for one round, after which your target returns to reality at its original position. <p>New Opportunities <br><span class='l5r'>O</span>+ : If you succeed, your target returns to reality at an unobstructed position of your choice a number of range bands away from its original position equal to <span class='l5r'>O</span> spent this way. <span class='l5r'>O</span>+: Choose one additional target with vigilance plus silhouette lower than or equal to the original target's per:<span class='l5r'>O</span> spent this way. <p>Magnitude <br>Magnitude 1-3: Your target is removed from reality for a number of additional rounds equal to the magnitude. <br>Magnitude 4+: If your target is an Adversary NPC or PC or an object with mystical properties, it is removed until the end of the scene. If your target is a Minion NPC or a mundane object, it is lost to the Void and permanently ceases to exist."
},{
...
effect: "Activation: Once per scene as a Scheme and Support action, you may make a TN 3 Theology (Void) check targeting one position at range 0- 2. This position must be one you cou ld reach via your normal means of movement. <p>Effects: If you succeed, you augment yourself, twisting the space around you so that you simultaneously exist at your current position and at the target position. You remain a sing le entity for the purposes of strife, fatigue, conditions, and effects, and other characters can target you by targeting you at any position you occupy. <br>If an effect reaches you at multiple locations, it affects you multiple times. When you choose targets for an action you perform, you may receive 2 fatigue to choose one additiona l target that is within range of at least one position you occupy, or to choose the same ta rget mult iple times if that target is with in range for the action f rom multiple positions you occupy. If you choose the same target multiple times this way, resolve the effect against them once for each time you chose them. This effect persists until the end of your next turn. When this effect ends, choose one of the positions you occupy: you cease to occupy all of your other positions. This effect persists a number of rounds equal to your ranks in Meditation. <p>Magnitude <br>Magnitude 1-2: This effect persists for a number of additiona l rounds equal to the magnitude. <br>Magnitude 1 +: Choose one additional target position per magnitude. You exist at each of those positions as well. <br>Magnitude 3+: This effect persists until the end of the scene. At the end of each round, receive 1 fatigue for each position you occupy."
},{
