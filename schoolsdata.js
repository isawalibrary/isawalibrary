...
Unicorn:{
	...
	Other:{
		...
		qamaristshieldbearer: {
			...
			rank2techs:["Goading Taunt","Iron Shield Style","Deflective Defense","Iron in the Mountains Style",],
			rank3techs:[],
			rank4techs:[],
			rank5techs:[],
			keyword: "gaijin",},
		qamaristalchemist: {
			...
			startingtechoptions: [],
			chooseoptions: 0,
			ability: "Creative Execution: When making a check to perform a ritual, you may receive fatigue up to your school rank to add that many kept dice to O results.",
