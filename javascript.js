...
function loadCampaign(){
	x="+Duel House Rules<br><br>1) Any ring can be called when using Predict.<br>RAW: Predict can only be called for Air, Earth, Fire and Water, not for Void.<br>Rationale: I don’t see any reason why void should be different & immune to Predict in this case.<br><br>2) Duelists in the staredown phase get an action which cannot be used to attack.  Draw, Center or Predict can be used here, as well as shuji or school abilities if appropriate.  Iaijutsu techs can use 2 Opportunities to sheathe their blade, 'reloading' the technique for free.<br>RAW: No actions can be taken during the staredown phase, it is just for initiative.  Predict, Center and Draw can only be used in the third phase of a duel.<br>Rationale: a) If a duelist does not have an Iaijutsu tech, Water stance is pretty much mandatory if that duelist is trying to win.  It is boring to have mandatory stances.  This house rule makes Iaijutsu techs a little bit less powerful, but the Iaijutsu tech user still has a significant advantage as he can spend his action here on Predict to potentially compromise his opponent and open him up for a Finishing Blow, or he can choose to Center and potentially guarantee a successful attack.  In order to balance this small nerf, Iaijutsu tech users can commit 2 Opportunities in order to sheathe their blade as part of the same movement after use, effectively reloading the tech so it can be used in successive turns.  <br>b) Additionally, in RAW, Predict is the most fun choice but does not make tactical sense - I want Predict and Center to be usable.<br><br>3) When striking or otherwise making an attack, if the strike misses, the attacker takes the defender's vigilance in strife.  <br>RAW: There is no penalty to missing a strike in a duel.<br>Rationale: This is to stop duels becoming two people slashing wildly at the air around each other until one connects – pretty sure duels should not look like this - as with the rules as written, this is pretty much the most effective tactic.  When there is a penalty to missing, Center action becomes more powerful and useful.  A high composure character can still slash wildly all around a low vigilance opponent for a while, but it is no longer the best strategy for everyone.<br><br>4) Endurance cannot be used to defend against attacks, every strike that hits is a critical.<br>RAW: You need to fill your opponent with fatigue before crits will start happening, unless you use Strike opps or Heartpiercing Strike to inflict a crit.  Earth stance denies the opponent the use of opps to cause crits.<br>Rationale: Earth stance is too strong in duels - it is strong enough in general life and skirmishes, it doesn't need to also dominate in duels as well.  The main purpose of this is because I don't think that the duelists should be hacking at each other until they run out of endurance, and I don’t think that all duelists should need to have high endurance to be effective duelists."
	x += "+Mirumoto Niten User Nerf<br><br>1) Mirumoto Niten school ability can only be used with a daisho.  No using karate chops with it, no using it with kusari-gama, no using it with anything other than your normal daisho.<br>RAW: You can use it with your hands, or with anything you want.<br>Rationale: Abusable, unthematic."
	x += "+Resist Checks Opportunity Spend House Rules<br><br>1) You cannot use Opportunities from your resist checks.  <br>RAW: You can use Opportunities from resist checks, resulting in perplexing situations where your opponent has made you stronger by trying to inflict a condition on you.  Also speeds things up."
	x += "+Prone House Rule<br><br>1) Prone characters cannot take actions that require checks.<br>RAW: Prone is an advantage, try not to make your opponents prone because it will make them stronger, it doesn't make anything more difficult for them except they move more slowly because they are not standing, lifeprotip: don't get up out of bed in the morning, spend all day slithering on the floor, be more effective or no less effective for less energy spent.<br>Rationale: The RAW is retarded in this case."
	x += "+Animal Handling Skill<br><br>1) Animal Handling is a separate skill under Trade skills, split from Survival.  If you can take Survival during character creation, you can choose to take Animal Handling instead."
	x +="+Dark Theology Skill<br><br>1) Dark Theology is a separate skill under Scholar skills, split from Theology.  If Theology covers 'the way things should be', Dark Theology covers things which are taboo or forbidden - diagnosing the Taint, being able to identify maho use, knowledge about oni etc.  If you can take Theology in character creation and your backstory or clan function support it, then you can choose to take Dark Theology instead (i.e. a Kuni shugenja would probably have access to Dark Theology learning materials and mentors, but an Asahina artificer would have no exposure under normal circumstances.)"
	x +="+Taint House Rules<br><br>Coming Soon"
	x +="+Critical Strike Rules<br><br>Coming Soon"
