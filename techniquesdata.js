...
reference: "Path of Waves",
ring: "Fire/Void",
effect: "Activation: When you make a check to resist a critical strike during a skirmish, if you are Enraged and not Incapacitated, you may spend <span class='l5r'>O</span> in the following way: Fire or Void <span class='l5r'>O</span>+:  Choose one of your unarmed profiles or a readied improvised weapon.  Each other character at range 0-1 with Vigilance lower than or equal to <span class='l5r'>O</span> spent this way suffers physical damage equal to the base damage of your unarmed profile plus 1 for each <span class='l5r'>O</span> spent in excess of their Vigilance.",},
{
...
reference: "Path of Waves",
ring: "Any",
effect: "Activation: When you make an Attack action check with a Cumbersome weapon, you may spend <span class='l5r'>O</span> in the following way: <span class='l5r'>O</span> <span class='l5r'>O</span>: If your target would suffer a critical strike as a result of this check, instead of making a check to resist, they suffer the severity 5-6: Debilitating Gash result (Critical Strikes, Core p270)",},
{
title: "Daring Swing",
type: "Kata",
rank: "3",
...
reference: "Path of Waves",
ring: "Fire",
effect: "Activation: When you make an Attack action check with a blunt weapon, you may spend <span class='l5r'>O</span> in the following way: Fire <span class='l5r'>O</span> <span class='l5r'>O</span>+: One character at range 0-1 of your target per <span class='l5r'>O</span> <span class='l5r'>O</span> spent this way receives 1 fatigue, or 3 fatigue if they are suffering the Dazed condition.",},
{
...
reference: "Path of Waves",
ring: "Any",
effect: "Activation: When you perform an Attack action check using a sword or axe, if you have another readied weapon of the same category, you may spend <span class='l5r'>O</span> in the following way: <span class='l5r'>O</span> <span class='l5r'>O</span>: If your target suffers a critical strike as a result of this check, increase its severity by the deadliness of your other weapon.",},
{
...
reference: "Path of Waves",
ring: "Air/Water",
effect: "Activation: When you perform a Maneuver action during your turn, you may spend <span class='l5r'>O</span> in the following way: Air or Water <span class='l5r'>O</span> <span class='l5r'>O</span>: After you move, you may perform a Strike action using a readied Ranged weapon targeting one character in range, treating the TN as equal to your target's vigilance.  You can only target a character you moved away from this way.",},
{
...
reference: "Path of Waves",
ring: "Air/Void",
effect: "Activation: When you perform a Ranged check you may spend <span class='l5r'>O</span> in the following way: Air or Void <span class='l5r'>O</span> <span class='l5r'>O</span>: If you did not succeed, choose another target at range 0-2 of your target with Vigilanc lower than or equal to your target's. The new target suffers physical damage equal to your weapon's base damage.",},
{
...
reference: "Path of Waves",
ring: "Earth",
effect: "Activation: When you make a check to resist an effect, you may spend <span class='l5r'>O</span> in the following way: Earth <span class='l5r'>O</span>+:  One character per <span class='l5r'>O</span> spent this way may immediately switch to a stance of their choice.",},
{
...
reference: "Path of Waves",
ring: "Air",
effect: "Activation: Once per scene, as a Scheme and Support action, you may make a Courtesy (Air) or Tactics (Air) check targeting two other characters who are not hostile to each other.  The TN of the check is equal to the highest Vigilance among your targets.  <br><br>Effects: If you succeed, choose one target and increase the TN of their next check by 2.  Decrease the TN of the other target's next check by 2.  This effect persists until the end of your next turn.  <br><br>New Opportunities: <br>Air <span class='l5r'>O</span>:  Neither of your targets realizes your duplicity in hindering one to help the other.  <br><br>Air <span class='l5r'>O</span> <span class='l5r'>O</span>: You can use this technique one additional time this scene.",},
{
title: "Pack Gambit",
type: "Shuji",
rank: "3",
...
reference: "Path of Waves",
ring: "Water",
effect: "Activation: Once per game session at the start of the scene, or as a Support action, you may make a TN 2 Scholar skill (Water) check targeting one character.  <br><br>Effects: If you succeed, that character treats their focus as 2 lower (to a minimum of 1) and their Vigilance as 2 higher.  This effect persists until the end of the scene.  <br><br>New Opportunities: <br>Water <span class='l5r'>O</span>+:  choose one additional target per <span class='l5r'>O</span> spent this way.  <br><br>Water <span class='l5r'>O</span>:  This effect persists until the end of the next scene instead.",},
{
...
reference: "Path of Waves",
ring: "Fire",
effect: "Activation: Once per session at the start of a scene, or as a Support action, you may make a TN 2 Scholar skill (Fire) check targeting one character.  <br><br>Effects: If you succeed, that character treats their Vigilance as 2 lower (to a minimum of 1) and their focus as 2 higher.  This effect persists until the end of the scene.  <br><br>New Opportunities: <br>Fire <span class='l5r'>O</span>+:  Choose one additional target per <span class='l5r'>O</span> spent this way.  <br><br>Fire <span class='l5r'>O</span>:  This effect persists until the end of the next scene instead.",},
{
title: "Goading Taunt",
type: "Shuji",
rank: "3",
...
reference: "Path of Waves",
ring: "Any",
effect: "Activation: Once per game session as a downtime activity while at a crossroads, in the wilderness, or another place where your path is unclear, you may make a TN 3 Meditation check.  <br><br>Effects: If you succeed, you encounter a sign of one of the following based on the ring you used.  Earth: Direction of someone with whom you share a bond.  Water: Direction of an opportunity to make money.  Fire: Direction of the nearest large scale conflict.  Air: Direction of a person related to your past or desire.  Void: Direction in which you are needed the most.  <br><br>New Opportunities: <br><span class='l5r'>O</span> <span class='l5r'>O</span>+: You see a sign revealing the same information for one additional person in the scene per <span class='l5r'>O</span> <span class='l5r'>O</span> spent this way.",},
{
