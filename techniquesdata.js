...
reference: "Core 213",
ring: "Any",
effect: "Activation: As a downtime activity, you may make a TN 2 Theology check using Air, Earth, Fire, Water, or Void targeting a threshold, gate, or other entryway at range 0-1 . <br>Effects: If you succeed, the threshold is barred against a particular type of entity, based on the ring you chose, for one hour, plus additional hours equal to your bonus <span class='l5r'>S</span>. When an entity of this type attempts to enter, it must resist with a TN 3 Meditation (Void) check or be repelled by the spiritual barrier. Whether it succeeds or fails, you immediately become aware of its attempted entry. The particular type of being is based on the ring you chose, as follows: <br><br><span class='l5r'>b</span> Air: Ethereal Otherworldly beings such as spirits and ghosts. <br><span class='l5r'>b</span> Earth: Living Tainted beings. <br><span class='l5r'>b</span> Fire: Undead beings with corporeal form . <br><span class='l5r'>b</span> Water: Wild animals. <br><span class='l5r'>b</span> Void: Humans. <br><br>New Opportunities <br><span class='l5r'>O</span>: Instead of protecting a threshold, you may protect the entirety of a sealed area that extends a number of range bands around you no greater than your bonus <span class='l5r'>S</span>. <br><span class='l5r'>O</span>: If any beings of the type you are attempting to seal the threshold against have passed through the threshold with in the last twenty-four hours, you become aware of their passage."},{
...
reference: "Path of Waves",
ring: "Air/Void",
effect: "Activation: When you perform a Ranged check you may spend <span class='l5r'>O</span> in the following way: <br><br>Air or Void <span class='l5r'>O</span> <span class='l5r'>O</span>: If you did not succeed, choose another target at range 0-2 of your target with Vigilance lower than or equal to your target's. The new target suffers physical damage equal to your weapon's base damage.",},
{
