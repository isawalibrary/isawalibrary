...
function loadCampaign(){
	...
	x += "<b>+Taint House Rules</b><br><br>Coming Soon, mostly my problem here is that Taint can only advance in increments of 20%, Taint does not grow over time, Taint is super avoidable if you just do basic self-upkeep in getting cleansed after being Afflicted.<br><br>"
