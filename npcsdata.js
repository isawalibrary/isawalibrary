...
weapon:["Tetsubo"],
armor:["O-Yoroi"],
qualities:"Kotoe has served at the Wall for many years. Long ago, her fellow Hida nicknamed her “Thirteenth Tower” both for her steadfast nature and her height. When outfitted in heavy ō-yoroi armor and her huge family tetsubō, she is indeed a towering figure, and many Hiruma returning from scouting missions claim they can spot her on the parapets from many miles away. She can often be found where the fighting is the thickest, especially wherever the Wall has suffered a breach. Legend has it she singlehandedly held off waves of goblins who had burrowed under the Wall until their blood made the tunnel too slippery for them to climb out—at which point she grimly waded in and killed the rest. Kotoe comes from a long line of warriors, all of whom only fell after killing so many creatures that paths had to be made through the piles of corpses to reach their bodies. She wishes nothing more than to end her days in the same manner; given her strength and prowess in battle, though, that day may be a long time coming.",
...
abilities:["Penetrating Spirit: As a descendant of the first Falcon daimyō, Hatsue can discern Otherworldly beings such as gaki and always recognize any such beings that attempt to disguise themselves as human or otherwise mundane. This does not, however, mean she always feels it is in the best interest of the Falcon or the being involved to reveal this to those around her."],
...
armor:["Ghostly Form"],
qualities:"Just as there are hierarchies and bureaucracies in the Mortal Realm of Ningen-dō, so there are ones in the Spirit Realms. The realm of Gaki-dō, where gaki and other hungry spirits are sent from Meido after being found wanting, is filled with administers and other officials who oversee the realm on the behalf of Emma-o, the Fortune of Death. Mazoku serve a vital role as magistrates and guards within Gaki-dō, but the sheer number of spirits there utterly overwhelms any attempt to properly keep them contained. Many gaki escape Gakidō to haunt Rokugan, especially in areas where the two realms draw near, such as where violent battles, terrible murders, and other blood-soaked horrors occurred. Hunting down and returning these troublesome spirits to Gaki-dō is nearly impossible for the mazoku, which is why they sometimes work with Phantom Hunters to jointly accomplish their common mission.",
abilities:["Magistrate of Gaki-Do: A mazoku is an Otherworldly being, though it appears as a normal samurai. It doubles its vigilance when detecting Otherworldly or Tainted beings, mahō use, or kansen activity. When a mazoku unmasks, everyone who can see it suffers 6 strife as its form shifts into inhuman shapes before settling as it composes itself.",],
source:"Shadowlands p85",
},{
...
weapon:["Knife", "Katana"],
armor:["Common Clothes"],
qualities:"A man of graying hair and quiet disposition, Ryūhei is a Fortunist monk who venerates Bishamon in particular. He is younger than many of his fellow monks who tend the Hall of Ancestors, having retired from his life as a samurai of the Akodo family at a relatively young age. He is appropriately solemn and reserved for a person with his duties, and he engages little even with his fellow monks. Ryūhei avoids visitors as much as possible; when it is unavoidable, he answers their queries about the hall with polite but perfunctory answers.<br> In fact, Ryūhei entered ascetic life to escape his past and avoid the scandal and trial that the discovery of his crimes would bring. In a heated confrontation over the affections of a geisha, a drunken and jealous Ryūhei murdered his friend and superior officer, Akodo Hisayo. However, while he escaped punishment for his crime, the man now known as Ryūhei could not escape his shame, or his victim. Hisayo haunts Ryūhei, her spirit unable to move on to Meido and her next life until she finds some manner of satisfaction for her dishonorable death. As much as Ryūhei wants to be free of his former officer, he would do almost anything to conceal his past.",
abilities:["Restless Spirits: While making a check, any character at range 0-5 of Ryūhei may spend <span class='l5r'>O</span> as follows: <span class='l5r'>O</span>: Receive 4 strife to gain 1 Void point."],
...
qualities:"Once, Hida Chobo was a soldier at the Kaiu Wall, until a massive oni shattered a tower Chobo was defending; Chobo’s leg was crushed in the rubble. The Crab Clan, always practical, took note of his keen mind and reassigned him to handling supplies and records at Kyūden Hida. There, Chobo has fulfilled his duties well. He’s often willing to swap tales with outsiders, although they may tire of his endless war stories. Because Chobo manages the flow of supplies in and out of Kyūden Hida, he is in regular communication with officers and personal friends throughout the southern Crab lands.",
...
weapon:["Tetsubo"],
armor:["Ashigaru Armor"],
qualities:"The guards who protect Kyūden Hida’s many gates are stalwart warriors and dangerous foes. Traditionally, the Hida rotate warriors off the Wall and give them ‘light duty’ such as this to allow them a chance to recuperate from the horrors of the Shadowlands. This means Kyūden Hida is guarded by hardened veterans; but they’re also gossipy, bored, and not good at keeping secrets.",
...
weapon:["Wakizashi"],
armor:["Ceremonial Robes"],
qualities:"Asako Raikū is an elderly monk who oversees Kyūden Asako in general and the palace library in particular. The library is a massive structure that looks ancient on the outside but, alone among the structures at Kyūden Asako, has modern appointments and furnishings on the inside in order to keep books and scrolls in a safe, dry environment. Historical scholarship is Raikū’s passion; the scrolls in the library range from novels to religious texts to documentation of archaeological sites such as ancient tombs that the Asako family unearthed. However, he is the pawn of a shinobi infiltrator who has uncovered blackmail material on Raikū’s immediate family from their own diaries.",
abilities:["Possessive Librarian: While in the Kyūden Asako library, when Raikū assists a character on a Scholar skill check, the character may reroll one die showing a blank result. However, if the character fails the check, Raikū receives 3 strife."],
...
weapon:["Wakizashi"],
armor:["Ceremonial Robes"],
qualities:"Imagine the perfect courtier. Well dressed. Beautiful. Graceful. Well versed in the classics, trained in the fine arts, capable of speaking with wit and insight on any topic. This is someone raised in Kyūden Doji.",
abilities:["Protocol and Procedure: Once per round, when another character succeeds on a check to pursue a social objective (Core p254) a Kyūden Doji courtier may receive up to 4 strife to reduce the number of bonus successes on that check by that amount, to a minimum of 0 bonus successes (the check still succeeds).","Tactful Recovery: Once per Intrigue scene, a Kyūden Doji courtier may change their social objective to another social objective they could complete during the scene. They may transfer up to half of their current momentum points to this new social objective."],
...
armor:["Concealed Armor"],
qualities:"Although she often masquerades as a simple messenger of the Deer Clan, Shika Tsuneko is far more accomplished and dangerous than she appears. In fact, she holds the title of First Spear amongst her clan’s bushi, meaning that she is a master of the yari and in times of war leads her fellow speardancers into battle. However, since the Deer avoid war at all costs, Tsuneko spends most of her time serving her clan daimyō Shika Renji. For his part, Renji sends Tsuneko on the most difficult missions, confident in her ability to succeed. When not among her fellow Deer, Tsuneko affects an air of naïve confusion and innocence to mask her considerable competence. However, she is genuinely good-hearted, and except when her duties call on her to kill, she tries to avoid dealing lasting harm to her opponents.",
...
weapon:["Bo"],
armor:["Common Clothes"],
qualities:"Michi is a monk of the Brotherhood of Shinsei from Dragon Clan lands. Michi wears a saffron robe and is overly fond of quoting—or misquoting—Shinsei. Michi has come to the village with the purpose of training and perhaps recruiting villagers into the Perfect Land Sect, but not even trainees have heard the monk repeat the sect’s chant or claim any affiliation. Michi simply offers the villagers training. If threatened or argued with, Michi retreats into the forest. Apart from training, Michi will not fight anyone. As a mysterious monk, Michi is untraceable and will reappear when the time is right. If Michi is attacked and defeated as an adversary, the monk escapes, but any PC who bests Michi gains 1 XP. Michi has clearly stayed in the village long enough to be a familiar figure and may appear anywhere in the village. Perhaps because Daizō disapproves, Michi enjoys teasing him. Michi might decide to pray at the shrine just as the priest is about to arrive to light incense or might loudly spout something mysterious and nonsensical when Daizō is about to give someone advice.",
abilities:["Everything is Connected: As an action, Michi can activate any rank 􀂣 kihō of any element, but cannot use the burst effect."],
