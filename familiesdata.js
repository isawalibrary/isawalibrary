...
var families = {
		hida: {
			...
			skill1:"Command",
			skill2:"Tactics",demeanor:["Intimidating","Loyal","Obstinate","Courageous","Suspicious"],
			glory:44,
			wealth:4,
			},
		hiruma: {
			...
			skill1:"Skulduggery",
			skill2:"Survival",demeanor:["Cautious","Opportunistic","Courageous","Gruff"],
			glory:39,
			wealth:3,
			},
		kaiu: {
			...
			skill1:"Smithing",
			skill2:"Labor",demeanor:["Adaptable","Opportunistic","Calculating","Gruff"],
			glory:40,
			wealth:5,
			},
		kuni: {
			...
			skill1:"Medicine",
			skill2:"Theology",demeanor:["Suspicious","Adaptable","Ambitious","Courageous"],
			glory:40,
			wealth:4,
			},
		yasuki: {
			...
			skill1:"Commerce",
			skill2:"Design",demeanor:["Opportunistic","Adaptable","Ambitious","Shrewd"],
			glory:39,
			wealth:10,
			},
		...
		clan:'Crane',
			...
			skill1:"Aesthetics",
			skill2:"Theology",demeanor:["Cautious","Meek","Fickle","Beguiling"],
			glory:40,
			wealth:6,
		},
		daidoji: {
		...
		clan:'Crane',
			...
			skill1:"Fitness",
			skill2:"Tactics",demeanor:["Courageous","Detached","Loyal","Opportunistic"],
			glory:40,
			wealth:7,
		},
		doji: {
		...
		clan:'Crane',
			...
			skill1:"Courtesy",
			skill2:"Design",demeanor:["Shrewd","Intimidating","Friendly","Ambitious","Proud"],
			glory:44,
			wealth:8,
		},
		kakita: {
		...
		clan:'Crane',
			...
			skill1:"Aesthetics",
			skill2:"Meditation",demeanor:["Intimidating","Proud","Fierce","Intense"],
			glory:44,
			wealth:7,
		},
		agasha: {
		...
		clan:'Dragon',
			...
			skill1:"Medicine",
			skill2:"Smithing",demeanor:["Curious","Detached",],
			glory:40,
			wealth:4,
		},
		kitsuki: {
		...
		clan:'Dragon',
			...
			skill1:"Government",
			skill2:"Sentiment",demeanor:["Suspicious","Intense","Shrewd","Assertive"],
			glory:44,
			wealth:6,		},
		mirumoto: {
		name:'Mirumoto',
		clan:'Dragon',
			...
			skill1:"Fitness",
			skill2:"Tactics",demeanor:["Intense","Courageous","Assertive","Detached"],
			glory:44,
			wealth:5,
		},
		togashi: {
		...
		clan:'Dragon',
			...
			skill1:"Fitness",
			skill2:"Theology",demeanor:["Detached","Intense",],
			glory:45,
			wealth:3,		},
		...
		clan:'Lion',
			...
			skill1:"Command",
			skill2:"Government",demeanor:["Intense","Aggressive","Calculating","Obstinate"],
			glory:44,
			wealth:5,		},
		ikoma: {
		name:'Ikoma',
		clan:'Lion',
			...
			skill1:"Composition",
			skill2:"Performance",demeanor:["Proud","Calculating","Assertive"],
			glory:40,
			wealth:5,		},
		kitsu: {
		name:'Kitsu',
		clan:'Lion',
			...
			skill1:"Meditation",
			skill2:"Theology",demeanor:["Proud","Intense"],
			glory:40,
			wealth:4,		},
		matsu: {
		name:'Matsu',
		clan:'Lion',
			...
			skill1:"Command",
			skill2:"Fitness",demeanor:["Proud","Intense","Aggressive","Fierce","Courageous","Angry"],
			glory:44,
			wealth:5,		},
		asako: {
		name:'Asako',
		clan:'Phoenix',
			...
			skill1:"Culture",
			skill2:"Sentiment",demeanor:["Shrewd","Suspicious","Adaptable",],
			glory:40,
			wealth:5,		},
		isawa: {
		name:'Isawa',
		clan:'Phoenix',
			...
			skill1:"Meditation",
			skill2:"Theology",demeanor:["Shrewd","Intimidating","Proud","Detached","Curious"],
			glory:44,
			wealth:5,		},
		shiba: {
		name:'Shiba',
		clan:'Phoenix',
			...
			skill1:"Fitness",
			skill2:"Theology",demeanor:["Loyal","Friendly","Courageous","Fierce"],
			glory:40,
			wealth:4,		},
		kaito: {
		name:'Kaito',
		clan:'Phoenix',
			...
			skill1:"Meditation",
			skill2:"Tactics",demeanor:["Meek","Friendly","Fierce"],
			glory:40,
			wealth:5,		},
		...
		clan:'Scorpion',
			...
			skill1:"Courtesy",
			skill2:"Performance",demeanor:["Loyal","Scheming","Ambitious","Shrewd","Opportunistic","Playful","Assertive","Suspicious","Calculating"],
			glory:40,
			wealth:6,		},
		shosuro: {
		name:'Shosuro',
		clan:'Scorpion',
			...
			skill1:"Design",
			skill2:"Theology",demeanor:["Loyal","Ambitious","Scheming","Shrewd","Cautious","Aggressive","Adaptable"],
			glory:40,
			wealth:6,		},
		soshi: {
		name:'Soshi',
		clan:'Scorpion',
			...
			skill1:"Design",
			skill2:"Theology",demeanor:["Loyal","Detached","Ambitious","Intense","Scheming"],
			glory:40,
			wealth:6,		},
		yogo: {
		name:'Yogo',
		clan:'Scorpion',
			...
			skill1:"Composition",
			skill2:"Theology",demeanor:["Loyal","Adaptable","Suspicious","Scheming"],
			glory:39,
			wealth:4,		},
		...
		clan:'Unicorn',
			...
			skill1:"Commerce",
			skill2:"Courtesy",demeanor:["Shrewd","Friendly","Calculating","Adaptable"],
			glory:40,
			wealth:9,		},
		iuchi: {
		name:'Iuchi',
		clan:'Unicorn',
			...
			skill1:"Meditation",
			skill2:"Theology",demeanor:["Obstinate","Adaptable"],
			glory:40,
			wealth:5,		},
		moto: {
		name:'Moto',
		clan:'Unicorn',
			...
			skill1:"Command",
			skill2:"Survival",demeanor:["Intense","Adaptable","Aggressive","Obstinate","Gruff"],
			glory:40,
			wealth:6,		},
		shinjo: {
		name:'Shinjo',
		clan:'Unicorn',
			...
			skill1:"Sentiment",
			skill2:"Survival",demeanor:["Friendly","Adaptable","Courageous","Assertive"],
			glory:44,
			wealth:8,		},
		utaku: {
		name:'Utaku',
		clan:'Unicorn',
			...
			skill1:"Survival",
			skill2:"Tactics",demeanor:["Courageous","Intense","Aggressive","Assertive"],
			glory:44,
			wealth:6,			},
		miya: {
			name:'Miya',
			...
			skill1:"Courtesy",
			skill2:"Culture",demeanor:["Proud","Shrewd","Assertive"],
			glory:44,
			wealth:8,
		},
		otomo: {
