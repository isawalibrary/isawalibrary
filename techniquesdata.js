...
reference: "Path of Waves",
ring: "Fire/Void",
effect: "Activation: When you make a check to resist a critical strike during a skirmish, if you are Enraged and not Incapacitated, you may spend <span class='l5r'>O</span> in the following way: <br>Fire or Void <span class='l5r'>O</span>+:  Choose one of your unarmed profiles or a readied improvised weapon.  Each other character at range 0-1 with Vigilance lower than or equal to <span class='l5r'>O</span> spent this way suffers physical damage equal to the base damage of your unarmed profile plus 1 for each <span class='l5r'>O</span> spent in excess of their Vigilance.",},
{
...
reference: "Path of Waves",
ring: "Any",
effect: "Activation: When you make an Attack action check with a Cumbersome weapon, you may spend <span class='l5r'>O</span> in the following way: <br><span class='l5r'>O</span> <span class='l5r'>O</span>: If your target would suffer a critical strike as a result of this check, instead of making a check to resist, they suffer the severity 5-6: Debilitating Gash result (Critical Strikes, Core p270)",},
{
title: "Daring Swing",
type: "Kata",
rank: "3",
...
reference: "Path of Waves",
ring: "Any",
effect: "Activation: When you make a Melee check with a blunt weapon or polearm, you may spend <span class='l5r'>O</span> in the following way: <br><span class='l5r'>O</span>+:  Choose one character in range of your weapon other than your target with Vigilance equal to or lower than <span class='l5r'>O</span> spent this way.  That character suffers physical damage equal to your weapon's base damage.  You may activate this <span class='l5r'>O</span> multiple times, choosing a different character each time.",},
{
...
reference: "Path of Waves",
ring: "Fire",
effect: "Activation: When you make an Attack action check with a blunt weapon, you may spend <span class='l5r'>O</span> in the following way: <br>Fire <span class='l5r'>O</span> <span class='l5r'>O</span>+: One character at range 0-1 of your target per <span class='l5r'>O</span> <span class='l5r'>O</span> spent this way receives 1 fatigue, or 3 fatigue if they are suffering the Dazed condition.",},
{
...
reference: "Path of Waves",
ring: "Any",
effect: "Activation: When you perform an Attack action check using a sword or axe, if you have another readied weapon of the same category, you may spend <span class='l5r'>O</span> in the following way: <br><span class='l5r'>O</span> <span class='l5r'>O</span>: If your target suffers a critical strike as a result of this check, increase its severity by the deadliness of your other weapon.",},
{
...
reference: "Path of Waves",
ring: "Air/Water",
effect: "Activation: When you perform a Maneuver action during your turn, you may spend <span class='l5r'>O</span> in the following way: <br>Air or Water <span class='l5r'>O</span> <span class='l5r'>O</span>: After you move, you may perform a Strike action using a readied Ranged weapon targeting one character in range, treating the TN as equal to your target's vigilance.  You can only target a character you moved away from this way.",},
{
...
reference: "Path of Waves",
ring: "Air/Void",
effect: "Activation: When you perform a Ranged check you may spend <span class='l5r'>O</span> in the following way: <br>Air or Void <span class='l5r'>O</span> <span class='l5r'>O</span>: If you did not succeed, choose another target at range 0-2 of your target with Vigilanc lower than or equal to your target's. The new target suffers physical damage equal to your weapon's base damage.",},
{
...
reference: "Path of Waves",
ring: "Earth",
effect: "Activation: When you make a check to resist an effect, you may spend <span class='l5r'>O</span> in the following way: <br>Earth <span class='l5r'>O</span>+:  One character per <span class='l5r'>O</span> spent this way may immediately switch to a stance of their choice.",},
{
