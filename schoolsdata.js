...
Unicorn:{
	...
	Other:{
		...
		studentofthetalon: {
			...
			rank1techs:["Flowering Deception","Chaotic Scattering"],
		...
		voiceofthewilds: {
			...
			techniquetypes: ["Rituals","Shuji"],
			startingtechs: [],
			startingtechoptions: ["Commune with Spirits","Divination","Well of Desire","Weight of Duty","Rustling of Leaves","Sensational Distraction"],
			chooseoptions: 3,
		...
		ujikdiviner: {
			...
			startingtechs: ["Ancestry Unearthed"],
			startingtechoptions: ["Commune with Spirits","Embrace of Kenro-Ji-Jin","Caress of Earth","Jurojin's Balm","Wall of Earth","Dance of Seasons","Heart of the Water Dragon","Dominion of Suijin","Inari's Blessing","Reflections of P'an Ku"],
			chooseoptions: 4,
		...
		qamaristshieldbearer: {
			...
			rank2techs:["Goading Taunt","Iron Shield Style",],
		...
		qamaristalchemist: {
			...
			rank2techs:["Fortitude's Draught","Boar's Wrath Style"],
			rank3techs:["Breath of the Wind Style","Look Out!"],
		...
		ivorykingdomsage: {
			...
			rank2techs:["Rider's Haste","Lord Hida's Grip"],
		...
		ivorykingdomdancingblades: {
			...
			rank2techs:["Rushing Ox Style","Summon Celestial Implement",],
			rank3techs:["Daring Swing","Bravado"],
			rank4techs:["Swirling Tempest Style","Roar of Encouragement"],
			rank5techs:["Sear the Wound","Immovable Hand of Peace"],
			keyword: "gaijin",},
			},
	Minor:{	
		sailor: {
